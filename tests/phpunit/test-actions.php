...
namespace SimplifiedWP\Links\Admin\Tests;
...
class Test_Admin extends WP_UnitTestCase {
	...
	public function test_add_admin_pages() {
		...
		$expected['simplified_links_reports']      	  = 'http://simplifiedtest.test/wp-admin/edit.php?post_type=simplifiedwp_links&page=simplified_links_reports';
		$expected['simplified_links_support']         = 'http://simplifiedtest.test/wp-admin/edit.php?post_type=simplifiedwp_links&page=simplified_links_support';
		$expected['simplified_links_more_plugins']    = 'http://simplifiedtest.test/wp-admin/edit.php?post_type=simplifiedwp_links&page=simplified_links_more_plugins';

		foreach ( $expected as $name => $value ) {
			$this->assertSame( $value, add_admin_pages( $name, false ) );
		}		
	}

...
class TestAdminActions extends WP_UnitTestCase {
	...
	public function test_register_hooks() {
		...
		$this->assertSame( 10, has_action( 'manage_cleanlinks_posts_custom_column', [ self::$class_instance, 'cleanlinks_custom_column_values' ] ), 10, 3 );
	...
	public function test_register_assets() {
		...
		self::$class_instance->register_assets( 'edit.php?post_type=cleanlinks' );
    ...
    private function admin_page_exists( $page_slug ) {
        ...
        if ( isset( $submenu['edit.php?post_type=cleanlinks'] ) ) {
            foreach ( $submenu['edit.php?post_type=cleanlinks'] as $submenu_item ) {
